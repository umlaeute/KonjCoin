...
static const int64_t STATIC_POS_REWARD = 100 * COIN; //Constant reward of 100 KONJ per block has been ignored
...
static const int64_t MAX_MONEY = 21000000000000 * COIN;
...
static const int nForkTwo = 1000;
