...
./konjungated --datadir=./test1 &
./konjungated --datadir=./test2 &
./konjungated --datadir=./test3 &
./konjungated --datadir=./test4 &
./konjungated --datadir=./test5 &
./konjungated --datadir=./test6 &
./konjungated --datadir=./test7 &
